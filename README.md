...
你可以在这里查看进阶版的示例项目：[OpenVoiceCall-iOS](https://github.com/AgoraIO/OpenVoiceCall-iOS)
...
然后在 [Agora.io SDK](https://www.agora.io/cn/blog/download/) 下载 **语音通话 + 直播 SDK**，解压后将其中的 **libs** 文件夹复制到本项目目录下，和 “Agora iOS Voice Tutorial” 文件夹平级。
...
- 如果发现了示例代码的bug, 欢迎提交 [issue](https://github.com/AgoraIO/Agora-iOS-Voice-Tutorial-Swift-1to1/issues)
